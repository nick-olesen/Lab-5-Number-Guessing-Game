...
int Game()
{
	...
	int ranNumber = rand() % 100 + 1; // output to screen random number between 1 and 100
...
void YouWinMessage()
{
	...
	WhatMessage = ranNumber; //Sets What Number to the random number generated
...
void NewGamePrompt()
{
	...
	case 6:
	{
		cout << "\nLook at the cool menu I built for you to play again!\n";
		break;
	}
